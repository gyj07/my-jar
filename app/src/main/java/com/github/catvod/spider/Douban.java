...
public class Douban extends Spider {
    ...
    private String apiHost = "https://frodo.douban.com";
    ...
    private JSONObject apiRequest(String path, Map<String, String> params) {
        ...
        StringBuilder sb = new StringBuilder(apiHost).append(path).append("?");
        boolean first = true;
    ...
    private JSONObject buildFilters() throws Exception {
        ...
        movieFilters.put(filterGroup("year", "年代", new String[][]{
        ...
        tvFilters.put(filterGroup("year", "年代", new String[][]{
